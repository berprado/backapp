...
Utilizado por empresas con alta emisión de facturas (entidades financieras, telecomunicaciones, servicios básicos). Debe registrarse en el Portal Web del SIN:

* **Periodicidad**: Diario, semanal o mensual
* **Tamaño**: Máximo 1000 facturas por paquete

### Primera Etapa

1. Generar archivo XML con modalidad **en línea**.
2. Firmar, validar y almacenar individualmente.

### Segunda Etapa

1. Recuperar facturas en XML.
...
5. Enviar paquetes:
   ...
   * Obtener nuevo **CUFD**
   * Enviar con servicio **Recepción de Paquetes**
   * Validar recepción con servicio **Validación de Paquetes**
