...
El Sistema Informáticos de Facturación, para interactuar con los servicios de la Administración Tributaria de Bolivia, deberá estar autorizado por el SERVICIO DE IMPUESTOS NACIONALES (SIN) y contar como mínimo con los siguientes componentes o funcionalidades:
