...
def sincronizar_parametrica_unidad_medida():
    mydb = None

    logging.debug('Iniciando sincronización de parametrica unidad de medida...')
    ...
    try:
        ...
        response = client.service.sincronizarParametricaUnidadMedida(solicitud)
        ...
        cursor.execute("""
        CREATE TABLE IF NOT EXISTS sincronizarparametricaunidadmedida (
        ...
        """)
        logging.debug('Tabla sincronizarparametricaunidadmedida verificada/creada.')
        ...
        if response.listaCodigos:
            for codigo in response.listaCodigos:
                ...
                sql = """
                INSERT INTO sincronizarparametricaunidadmedida (codigoClasificador, descripcion, fecha_creacion, fecha_sincronizacion, estado_sincronizacion)
...
if __name__ == "__main__":
    ...
    sincronizar_parametrica_unidad_medida()
