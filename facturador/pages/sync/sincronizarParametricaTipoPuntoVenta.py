...
def sincronizar_parametrica_tipo_punto_venta():
    mydb = None

    logging.debug('Iniciando sincronización de parametrica tipo de punto de venta...')
    ...
    try:
        ...
        response = client.service.sincronizarParametricaTipoPuntoVenta(solicitud)
        ...
        cursor.execute("""
        CREATE TABLE IF NOT EXISTS sincronizarParametricaTipoPuntoVenta (
        ...
        """)
        logging.debug('Tabla sincronizarParametricaTipoPuntoVenta verificada/creada.')
        ...
        if response.listaCodigos:
            for codigo in response.listaCodigos:
                ...
                sql = """
                INSERT INTO sincronizarParametricaTipoPuntoVenta (codigoClasificador, descripcion, fecha_creacion, fecha_sincronizacion, estado_sincronizacion)
...
if __name__ == "__main__":
    ...
    sincronizar_parametrica_tipo_punto_venta()
