    ...
    try:
        ...
        if response.listaLeyendas:
            for leyenda in response.listaLeyendas:
                print("Procesando leyenda:", leyenda)
            ...
            # Actualizar fecha de sincronización de todas las leyendas
            cursor.execute(
                """
                UPDATE sincronizarlistaleyendasfactura
                SET fecha_sincronizacion = NOW(), estado_sincronizacion = 'Exitoso'
            ...
            mydb.commit()
            print("No se encontraron nuevas leyendas, se actualizó la fecha de sincronización de las existentes.")
