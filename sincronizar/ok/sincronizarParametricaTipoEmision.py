...
def sincronizar_parametrica_tipo_emision():
    mydb = None

    logging.debug('Iniciando sincronización de parametrica tipo de emisión...')
    ...
    try:
        ...
        response = client.service.sincronizarParametricaTipoEmision(solicitud)
        ...
        cursor.execute("""
        CREATE TABLE IF NOT EXISTS sincronizarParametricaTipoEmision (
        ...
        """)
        logging.debug('Tabla sincronizarParametricaTipoEmision verificada/creada.')
        ...
        if response.listaCodigos:
            for codigo in response.listaCodigos:
                ...
                sql = """
                INSERT INTO sincronizarParametricaTipoEmision (codigoClasificador, descripcion, fecha_creacion, fecha_sincronizacion, estado_sincronizacion)
...
if __name__ == "__main__":
    ...
    sincronizar_parametrica_tipo_emision()
