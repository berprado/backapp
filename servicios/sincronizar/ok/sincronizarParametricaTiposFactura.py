...
def sincronizar_parametrica_tipos_factura():
    mydb = None

    logging.debug('Iniciando sincronización de parametrica tipos de factura...')
    ...
    try:
        ...
        response = client.service.sincronizarParametricaTiposFactura(solicitud)
        ...
        cursor.execute("""
        CREATE TABLE IF NOT EXISTS sincronizarParametricaTiposFactura (
        ...
        """)
        logging.debug('Tabla sincronizarParametricaTiposFactura verificada/creada.')
        ...
        if response.listaCodigos:
            for codigo in response.listaCodigos:
                ...
                sql = """
                INSERT INTO sincronizarParametricaTiposFactura (codigoClasificador, descripcion, fecha_creacion, fecha_sincronizacion, estado_sincronizacion)
...
if __name__ == "__main__":
    ...
    sincronizar_parametrica_tipos_factura()
