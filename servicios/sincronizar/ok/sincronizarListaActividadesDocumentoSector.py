    ...
    try:
        ...
        if response.listaActividadesDocumentoSector:
            for actividad in response.listaActividadesDocumentoSector:
                ...
                sql = """
                INSERT INTO sincronizarListaActividadesDocumentoSector (codigoActividad, codigoDocumentoSector, tipoDocumentoSector, fecha_creacion, fecha_sincronizacion, estado_sincronizacion)
                VALUES (%s, %s, %s, NOW(), NOW(), 'Exitoso')
                ON DUPLICATE KEY UPDATE 
                    tipoDocumentoSector = VALUES(tipoDocumentoSector), 
